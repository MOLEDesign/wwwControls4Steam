...
<div<?php echo $class; ?> data-uk-slideset="<?php echo $options; ?>">
    ...
    <div class="uk-slidenav-position uk-margin">
		...
		<?php 
		//[CHANGE] Creating unique $groupcode variable to be used as a lightbox group id.
        ...
        <?php foreach ($items as $item) :
                ...
                if ($item['link']) {
                    ...
                    if ($settings['panel_link']) {
						...
						//[CHANGE] Adding lightbox effect here:
						//ORIGINAL: $overlay = '<a class="uk-position-cover" href="' . $item->escape('link') . '"' . $link_target . '></a>';
            ...
            <li<?php echo $filter; ?>>
                ...
                <div class="<?php echo $panel; ?><?php echo $panel_hover; ?> uk-text-<?php echo $settings['text_align']; ?>">
					...
					<?php 
					//[CHANGE] Adding lightbox effect here:
					//ORIGINAL: <a class="uk-position-cover uk-position-z-index" href="<?php echo $item->escape('link'); ?>"<?php echo $link_target; ?>></a>
					?>
